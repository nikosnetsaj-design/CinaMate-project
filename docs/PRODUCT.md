...
| **Togliere dalla lista senza eliminare** | L'unico pulsante che faceva sparire un titolo dalla watchlist era *Elimina*, che cancella anche voto e note | «La mia lista» toglie oltre che mettere: il titolo torna *Sullo scaffale*, il sesto stato — in libreria, non visto, non pianificato — che esiste proprio perché annullare una promessa non è né abbandonare né mettere in pausa | Essenziale ✅ |
| **«Togli dalla libreria»** | *Elimina* faceva temere che sparisse tutto, video compresi | Stessa funzione, nome che dice cosa fa; la conferma elenca cosa esce (scheda, voto, note) e cosa non viene toccato (i tuoi file) | Utile ✅ |
