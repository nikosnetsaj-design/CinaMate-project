...
| **Pastiglie di scorciatoia e menu in cima** | Filtrare per genere voleva dire aprire Libreria e poi i filtri; le uscite stavano in Scopri; il Link Host tre tocchi dentro le Impostazioni | Sopra la vetrina, una fila che scorre: Serie TV · Film · Da vedere · Generi ⌄, ognuna porta in Libreria col filtro acceso. In barra restano le cose che riguardano *l'app*: campanella e tre puntini (Link Host, Web Viewer, Aggiorna contenuti) | Utile ✅ |
...
| **Episodi dentro il lettore** | Il pannello «Episodi» elencava gli altri titoli dello scaffale: la risposta giusta a una domanda che non si fa mentre si guarda una serie a metà stagione | Le puntate vere della stagione in onda — fotogramma, durata, trama, tendina delle stagioni, quella in corso evidenziata — e un tocco riparte da lì. Gli altri titoli restano, nella seconda scheda | Utile ✅ |
...
| **Dettagli senza salvare** | Per leggere una trama bisognava prima aggiungere il titolo, cioè decidere prima di avere in mano le cose su cui si decide | Il tocco apre la scheda intera del titolo che non hai — trama, cast, dove guardarlo, troupe, incassi, media, correlati — e «Aggiungi alla libreria» resta un passo separato. Vale anche per i correlati, i capitoli di saga mancanti e la filmografia di una persona | Essenziale ✅ |
